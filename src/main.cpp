...
bool testConnection(const std::string& host, const std::string& user, const std::string& password, const std::string& database) {
...
int main(int argc, char const *argv[])
{
    ...
    if (testConnection(host, user, password, database)) {
        std::cout << "Conexão bem sucedida!" << std::endl;
    } else {
        std::cout << "Conexão não estabelecida!" << std::endl;
    }
